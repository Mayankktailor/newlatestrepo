...
const Cart = ()=>{
    ...
    const handleCheckout = async ()=>{
        ...
        if (response.status !== 200) {
            react_hot_toast__WEBPACK_IMPORTED_MODULE_5__["default"].error(`Failed to Proceed because of ${response.status}`);
            return;
        }
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                children: "2022 Xgen Store All rights reserverd"
            }),
...
const getStripe = ()=>{
    if (!stripePromise) {
        stripePromise = (0,stripe_js_namespaceObject.loadStripe)(process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY);
    }
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_Layout__WEBPACK_IMPORTED_MODULE_2__, react_hot_toast__WEBPACK_IMPORTED_MODULE_3__, _context_StateContext__WEBPACK_IMPORTED_MODULE_4__]);
([_components_Layout__WEBPACK_IMPORTED_MODULE_2__, react_hot_toast__WEBPACK_IMPORTED_MODULE_3__, _context_StateContext__WEBPACK_IMPORTED_MODULE_4__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,166,996,468], () => (__webpack_exec__(8510)));
